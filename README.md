...
.button1 {
  background-color: rgb(222, 243, 195); 
  color: black; 
  border: 3px solid #0ebd14;
}
...
.button3:hover {
  ...
  <body id="a" style= " margin-left: 5%; margin-right: 5%; border: #000000 solid 8px">
    ...
    <div id="b" align="center">
        ...
        <button onclick="window.open('https://selfregistration.cowin.gov.in/','_blank')" class="button button2"> <b>Cowin</b></button>
        ...
        <button onclick="window.open('https://myaadhaar.uidai.gov.in/','_blank')" class="button button1"> <b>Aadhar Card</b></button>
  ...
  <button onclick="window.open('https://pacsonline.bih.nic.in/fsy/','_blank')" class="button button2"> <b>Fasal Bima</b></button>
 
 
  <button onclick="window.open('https://connect.csc.gov.in/account/authorize?response_type=code&client_id=0f8ca686-5a31-46b8-bb51-d9834ba9fa9d&redirect_uri=https%3A%2F%2Fdigitalseva.csc.gov.in%2Fauth%2Fcallback%2F&state=75885','_blank')" class="button button2"> <b>Digital Seva</b></button>


  
  <button onclick="window.open('https://register.eshram.gov.in/#/user/self','_blank')" class="button button2"> <img src="" alt=""> <b>e-Sharam</b></button>
  ...
  <button onclick="window.open('https://sbpdcl.co.in/(S(qejignhvhz5cloy0unxrpn13))/frmquickbillpaymentall.aspx','_blank')" class="button button1"> <b>Bijali Bill</b></button>
...
<button onclick="window.open('https://electoralsearch.in/','_blank')" class="button button2"> <b>Voter Detail</b></button>
<button onclick="window.open('http://epds.bihar.gov.in/DistrictWiseRationCardDetailsBH.aspx','_blank')" class="button button2"> <b>Ration Card</b></button>
<button onclick="window.open('http://scm.bihar.gov.in/dealer_challan.jsp','_blank')" class="button button2"> <b>E-Challan</b></button>
